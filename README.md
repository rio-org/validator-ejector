...
| OPERATOR_REGISTRY_ADDRESS      | Yes      | 0x123                 | Address of the Operator Registry contract: [Holesky](https://holesky.etherscan.io/address/0x29c1e0cF40Dc96573076b2C8c271fe4AFfDfc631)                        |
| OPERATOR_ID                    | Yes      | 123                   | Operator ID in the Operator Registry, provided to you by the RioDAO, and available in the [Operator dashboard](https://operators.rio.network/)                                                                         |
